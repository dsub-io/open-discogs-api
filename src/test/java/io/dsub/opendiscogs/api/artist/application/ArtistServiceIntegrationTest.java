package io.dsub.opendiscogs.api.artist.application;
...
import io.dsub.opendiscogs.api.artist.infrastructure.ArtistRepositoryImpl;
        ...
        .flatMap(i -> databaseClient
            .sql("""
                INSERT INTO release_item_credited_artist
                  (created_at, last_modified_at, release_item_id, artist_id, hash, role)
