package io.dsub.opendiscogs.api.artist.controller;
...
import io.dsub.opendiscogs.api.artist.application.ArtistService;
...
import io.dsub.opendiscogs.api.artist.query.ArtistQuery;
...
class ArtistControllerUnitTest extends ConcurrentTest {
  ...
  void searchArtistsReturns() {
    ...
    var gotResponse = client.get()
        ...
        .expectBody(new ParameterizedTypeReference<PagedResponseDTO<Artist>>() {
        })
        .returnResult()
        .getResponseBody();
  ...
  void getArtistReleasesReturns() {
    ...
    var result = client.get()
        ...
        .exchange()
        .expectBody(new ParameterizedTypeReference<PagedResponseDTO<ArtistReleaseDTO>>() {
        })
        .returnResult();
