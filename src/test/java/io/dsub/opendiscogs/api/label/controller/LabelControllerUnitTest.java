package io.dsub.opendiscogs.api.label.controller;
...
import io.dsub.opendiscogs.api.label.application.LabelService;
import io.dsub.opendiscogs.api.label.domain.Label;
import io.dsub.opendiscogs.api.label.domain.LabelRepository;
import io.dsub.opendiscogs.api.label.dto.LabelDetailDTO;
...
class LabelControllerUnitTest extends ConcurrentTest {
  ...
  void searchLabelsReturns() {
    ...
    var gotResponse = client.get()
        ...
        .expectBody(new ParameterizedTypeReference<PagedResponseDTO<Label>>() {
        })
        .returnResult()
        .getResponseBody();
  ...
  void getLabelReleasesReturns() {
    ...
    var result = client.get()
        ...
        .exchange()
        .expectBody(new ParameterizedTypeReference<PagedResponseDTO<LabelReleaseDTO>>() {
        })
        .returnResult();
